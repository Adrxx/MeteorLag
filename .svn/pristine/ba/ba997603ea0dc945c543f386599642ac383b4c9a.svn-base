...
public class Entity implements IEntity {
	...
	public void setAlpha(final float pAlpha) {
        ...
        float checkedAlpha = pAlpha;
        if (this.hasParent())
        {
            checkedAlpha = Math.min(pAlpha, this.getParent().getAlpha());

        }

		if (this.mColor.setAlphaChecking(checkedAlpha)) { // TODO Is this check worth it?
			this.onUpdateColor();
        }
	}

    public void setWaterfallAlpha(final float pAlpha)
    {
