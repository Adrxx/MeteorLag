...
public class GameControl extends SimpleBaseGameActivity
{
    ...
    // *** Se implementa para pausar la música en caso de que esté repoduciendo al salir
    @Override
    public synchronized void onPauseGame() {
        // Pausar la música de JUEGO_DOS
        if (scenesController!=null && scenesController.getActualSceneType()==SceneType.MENU_SCENE) {
            // Esta en JuegoDos, revisar si está reproduciendo música
            MenuScene escena = (MenuScene)scenesController.getEscenaActual();
            Music musicaFondo = escena.musicaFondo;
