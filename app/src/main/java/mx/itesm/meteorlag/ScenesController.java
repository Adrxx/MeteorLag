...
public class ScenesController
{
    ...
    private BaseScene escenaCreditos;
    ...
    private ResourcesController admRecursos = mx.itesm.meteorlag.ResourcesController.getInstance();
    ...
    public void crearEscenaJuego(String id) {
        // Carga los recursos
        escenaJuego = new MainGameScene();
        MainGameScene gs = (MainGameScene) escenaJuego;
        gs.createSceneFromLevel(id);
    }
